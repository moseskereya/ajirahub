        ...
        <div class="row justify-content-center">
          <div class="col-auto">
            <div class="footer-title text-center">
              ...
              <div>We're here to help. Check out our FAQs, send us an email or call us at 2 600 7777 9999</div>
            </div>
          </div>
        </div>
      </div>
                      ...
                      <div class="newsletter-form">
                        ...
                        <form method="post" action="#" id="subscribe-form">
                          ...
                          <div class="form-group">
                            ...
                            <button type="button" id="subscribe-newslatters" class="theme-btn bg-orange"><i class="flaticon-envelope"></i></button>
                          </div>
                        </form>
                      </div>
                    </div>
